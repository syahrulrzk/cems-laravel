                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-4">
                                                <fieldset class="form-group">
                                                    <label>Tanggal</label>
                                                    <input id="singledate" type="text" class="form-control pickadate" placeholder="Pilih Tanggal" autocomplete="off" required="required">
                                                </fieldset>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <fieldset class="form-group">
...
$(document).ready(function () {
    ...
    $('#form').on('submit', function(e) {
        ...
        var dateVal = $('#singledate').val();
        var data = $(this).serializeArray();
        data.push({name: 'fromdate', value: dateVal});
        data.push({name: 'todate', value: dateVal});
