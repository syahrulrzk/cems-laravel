...
@section('title', 'Report By Month - CEMS')
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-4">
                                                <fieldset class="form-group">
                                                    <label>Bulan Jurnal</label>
                                                    <input id="monthdate" type="month" class="form-control" required="required">
                                                </fieldset>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <fieldset class="form-group">
...
$(document).ready(function () {
    ...
    $('#form').on('submit', function(e) {
        ...
        var todate = month + '/' + (lastDay < 10 ? '0'+lastDay : lastDay) + '/' + year;

        var data = $(this).serializeArray();
        data.push({name: 'fromdate', value: fromdate});
        data.push({name: 'todate', value: todate});
