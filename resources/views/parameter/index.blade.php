...
@section('title', 'Parameter Management - CEMS')
    ...
    function fetch_db() {
        ...
        $('#datatable').DataTable({
            ...
            'columnDefs' : [{
                ...
                'data' : 5,
                'render' : function (data, type, row, meta) {
                    return '<div class="text-center"><span class="badge" style="background-color:'+data+'">'+data+'</span></div>';
                }
            }, {
                'targets' : 6,
                'data' : 6,
                'render' : function (data, type, row, meta) {
                    if (data == 'active') {
                        ...
                        return '<div class="text-center"><span class="badge badge-danger">INACTIVE</span></div>';
                    }
                }
            }, {
                'targets' : 7,
